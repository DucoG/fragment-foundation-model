"""Create a class that masks the input data. In particular the input will be a tokenized sequence of DNA and fragment metadata. The masking will be done by replacing the DNA and/or metadata with a mask token."""
